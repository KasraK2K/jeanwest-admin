...
export const MapCustomerType: Map<string, IMapCustomerType> = new Map([
  ...
  ["3", { erpName: "Blue", name: "Blue", color: "#9EF9FC" }],
  ["4", { erpName: "Blue+", name: "Blue+", color: "#44BFFF" }],
  ["5", { erpName: "Blue2+", name: "Blue2+", color: "#3C6AAE" }],
  ["6", { erpName: "Silver", name: "Silver", color: "#ACACAC" }],
  ["7", { erpName: "Gold", name: "Gold", color: "#F0C33C" }],
  ["8", { erpName: "Platinum", name: "Platinum", color: "#3C084E" }],
