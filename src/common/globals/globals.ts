...
export const globals = {
  ...
  mediaServerStatic: `${process.env.VUE_APP_MEDIA_PROTOCOL_STATIC}://${process.env.VUE_APP_MEDIA_URL_STATIC}:${process.env.VUE_APP_MEDIA_PORT_STATIC}/${process.env.VUE_APP_MEDIA_PATH_STATIC}`,
